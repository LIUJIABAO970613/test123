...
public class TestClassObject01 {
	public static void main(String[] args)throws Exception {
		System.out.println(
		"TestClassObject01.args="
		+Arrays.toString(args));
		ClassLoader loader=
		ClassLoader.getSystemClassLoader();
		System.out.println(loader);//AppClassLoader
		
		//获取TestClassObject01的"字节码对象"
		Class<?> c1=TestClassObject01.class;
		Class<?> c2=Class.forName("com.company.java.oop.cls.TestClassObject01");
		System.out.println(c1==c2);
		TestClassObject01 instance=
		new TestClassObject01();
